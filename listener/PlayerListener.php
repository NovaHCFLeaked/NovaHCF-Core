        ...
        if($player instanceof MDPlayer){
            switch ($player->getRank()){
                case MDPlayer::BRONZE:
                    $rank = TextFormat::GRAY . TextFormat::BOLD . $player->getName() . "(Bronze) " . TextFormat::RESET . TextFormat::GRAY;
                    break;
                case MDPlayer::SILVER:
                    $rank = TextFormat::GRAY . TextFormat::BOLD . $player->getName() . "(Silver) " . TextFormat::RESET . TextFormat::GRAY;
                    break;
                case MDPlayer::GOLD:
                    $rank = TextFormat::GOLD . TextFormat::BOLD . $player->getName() . "[Gold] " . TextFormat::RESET . TextFormat::GRAY;
                    break;
                case MDPlayer::DIAMOND:
                    $rank = TextFormat::DARK_AQUA . TextFormat::BOLD . $player->getName() . "(Diamond) " . TextFormat::RESET . TextFormat::GRAY;
                    break;
