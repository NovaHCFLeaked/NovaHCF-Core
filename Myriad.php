...
class Myriad extends PluginBase
{
    ...
    public function registerProtection(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::PROTECTION, "Protection", 0, 0, Enchantment::SLOT_ARMOR, 4));
        new Protection($this);
    }
    ...
    public function registerFireProtection(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::FIRE_PROTECTION, "Fire protection", 1, 0, Enchantment::SLOT_ARMOR, 2));
    ...
    public function registerFeatherFalling(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::FEATHER_FALLING, "Feather falling", 1, 0, Enchantment::SLOT_FEET, 3));
    ...
    public function registerBlastProtection(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::BLAST_PROTECTION, "Blast protection", 1, 0, Enchantment::SLOT_ARMOR, 2));
    ...
    public function registerProjectileProtection(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::PROJECTILE_PROTECTION, "Projectile protection", 1, 0, Enchantment::SLOT_ARMOR, 2));
    ...
    public function registerThorns(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::THORNS, "Thorns", 1, 0, Enchantment::SLOT_ARMOR, 3));
    }
    ...
    public function registerRespiration(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::RESPIRATION, "Respiration", 1, 0, Enchantment::SLOT_HEAD, 2));
    }
    ...
    public function registerDepthStrider(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::DEPTH_STRIDER, "Depth strider", 1, 0, Enchantment::SLOT_FEET, 2));
    ...
    public function registerAquaAffinity(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::AQUA_AFFINITY, "Aqua Affinity", 1, 0, Enchantment::SLOT_HEAD, 1));
    }
    ...
    public function registerSharpness(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::SHARPNESS, "Sharpness", 1, 0, Enchantment::SLOT_TOOL, 5));
        new Sharpness($this);
    }
    ...
    public function registerSmite(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::SMITE, "Smite", 1, 0, Enchantment::SLOT_SWORD, 3));
        new Smite($this);
    }
    ...
    public function registerBaneOfArthropods(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::BANE_OF_ARTHROPODS, "Bane of Arthropods", 1, 0, Enchantment::SLOT_SWORD, 2));
    ...
    public function registerKnockback(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::KNOCKBACK, "Knockback", 1, 0, Enchantment::SLOT_SWORD, 2));
        new Knockback($this);
    }
    ...
    public function registerFireAspect(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::FIRE_ASPECT, "Fire aspect", 1, 0, Enchantment::SLOT_SWORD, 2));
        new FireAspect($this);
    }
    ...
    public function registerLooting(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::LOOTING, "Looting", 1, 0, Enchantment::SLOT_SWORD, 3));
        new Looting($this);
    }
    ...
    public function registerEfficiency(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::EFFICIENCY, "Efficiency", 1, 0, Enchantment::SLOT_PICKAXE, 5));
    }
    /**
    ...
    public function registerSilkTouch(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::SILK_TOUCH, "Silk touch", 2, 0, Enchantment::SLOT_TOOL, 1));
        new SilkTouch($this);
    }
    ...
    public function registerUnbreaking(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::UNBREAKING, "Unbreaking", 0, 0, Enchantment::SLOT_TOOL, 3));
        new Unbreaking($this);
    }
    ...
    public function registerFortune(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::FORTUNE, "Fortune", 0, 0, Enchantment::SLOT_PICKAXE, 3));
        new Fortune($this);
    }
    /**
      * @void registerPower
    ...
    public function registerPower(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::POWER, "Power", 0, 0, Enchantment::SLOT_BOW, 5));
        new Power($this);
    }
    ...
    public function registerPunch(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::PUNCH, "Punch", 1, 0, Enchantment::SLOT_BOW, 2));
        new Punch($this);
    }
    ...
    public function registerFlame(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::FLAME, "Flame", 1, 0, Enchantment::SLOT_BOW, 2));
        new Flame($this);
    }
    ...
    public function registerInfinity(){
        Enchantment::registerEnchantment(new Enchantment(Enchantment::INFINITY, "Infinity", 2, 0, Enchantment::SLOT_BOW, 1));
        new Infinity($this);
