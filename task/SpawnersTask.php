...
class SpawnersTask extends Task
{
    ...
    public function onRun(int $currentTick)
    {
        ...
        if ($this->time == 0) {
            $this->time = 120;
			$message = [Utils::getPrefix() . TextFormat::BOLD . TextFormat::GREEN . "You can buy ranks at validhcf.buycraft.net" . TextFormat::RESET, Utils::getPrefix() . TextFormat::BOLD . TextFormat::GREEN . "Vote us on @ValidHCF to win a Rank!" . TextFormat::RESET, Utils::getPrefix() . TextFormat::BOLD . TextFormat::GREEN . "Make you sure to Follow @ValidHCF on twitter and join our discord!" . TextFormat::RESET][mt_rand(0, 2)];
